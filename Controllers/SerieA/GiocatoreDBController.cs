...
namespace DBControllers.SerieA
{
    public class GiocatoreDBController : BaseDBController
    {
        ...
        public int InsertGiocatore(string nome, string cognome, string gazzettaId)
        {
            int ret = 0;
        ...
        public int InsertVotoDelGiocatore(int idGiocatore, int idGiornata,
        ...
        public int InsertStatisticaDelGiocatorePerStagione(int idGiocatore, int idStagione,
